...
public class Command {
    ...
    */
    static void removeStock(String ans) {
        if (stockList.removeIf(n -> n.ticker.equals(ans.toUpperCase()))){
            System.out.println("Stocklist after removing: " + stockList + "\n");
    ...
    /*
    Overloaded update stock method, updates stock arrayList values using JTextield values.
     */
    ...
    Jtextfields in GUI.
     */
    static void addStock(String stock,String ticker,String description,double currentPrice,double numbPurchased,double purchasePrice,float dividend) {
        stockList.add(new Stock(stock, ticker, description, currentPrice, numbPurchased, purchasePrice, dividend));
        System.out.println("Updated stockList: " + stockList);
    }
